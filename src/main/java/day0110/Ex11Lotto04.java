...
public class Ex11Lotto04 {
    ...
    public static void main(String[] args) {
        ...
        Ex10Lotto03Answer.setAutoNumbers(computernumbers);
        Ex10Lotto03Answer.sort(computernumbers);
    ...
    public static int countSame(int[] computerNumbers, int[] userNumbers) {
        ...
        for(int i =0; i < computerNumbers.length; i++){
            if(Ex10Lotto03Answer.contains(userNumbers,computerNumbers[i])){
                count++;
            }
        }
        return count;
    ...
    public static void setNumbers(int[][] arrays) {
        for(int i =0; i<arrays.length;i++){
            ...
            if (userChoice ==1){
                Ex10Lotto03Answer.setAutoNumbers(arrays[i]);
            } else{
                Ex10Lotto03Answer.setManualNumbers(arrays[i]);
            }

            Ex10Lotto03Answer.sort(arrays[i]);
